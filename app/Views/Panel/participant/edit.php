    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="row text-white justify-content-center">
            <div id="form-content" class="col-lg-10">
                <a href="edit.php" class="btn btn-light bg-white btn-md mb-3 font-weight-bold">Update Peserta</a>
                <form id=" contact-form" method="post" action="contact.php" role="form">
                    <div class="form-group">
                        <label for="form_name">Nama Event: </label>
                        <input type="password" class="form-control" placeholder="Masukkan Nama Event">
                    </div>
                    <div class="form-group">
                        <label for="form_name">Nama Peserta: </label>
                        <input type="password" class="form-control" placeholder="Masukkan Nama Peserta">
                    </div>
                    <div class="form-group">
                        <label for="form_number">Jumlah Pembayaran: </label>
                        <input type="number" class="form-control" placeholder="Masukan Jumlah Pembayaran">
                    </div>
                    <div class="form-group">
