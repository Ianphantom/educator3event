                    ...
                    <div class="col-xl-8 offset-xl-2 py-5">
                        <form id="contact-form" method="post" action="contact.php" role="form">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="form_name">ID Bank </label>
                                        <input id="form_name" type="text" name="id" class="form-control" placeholder="Masukkan ID Bank" required="required" data-error="ID Bank Diperlukan">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
